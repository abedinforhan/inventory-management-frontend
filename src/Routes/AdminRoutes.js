...
const adminRoute = [
...

  {
    ...
    subMenu: [
      ...
      {
        name: 'Store List', icon: TbWaveSawTool, path: '/store/store-list', component: StoreList,
      }
    ],
  },
  {
...

  {
    ...
    subMenu: [
      {
        name: 'Dhaka', icon: TbWaveSawTool, path: '/stock', component: Stock,
      },
      {
        name: 'Chattogram', icon: TbWaveSawTool, path: '/stock', component: Stock,
      }
    ],
  },
  {
    ...
    subMenu: [
      {
        name: 'Suppliers', icon: TbWaveSawTool, path: '/people/supplier-list', component: SupplierList,
      },
      {
